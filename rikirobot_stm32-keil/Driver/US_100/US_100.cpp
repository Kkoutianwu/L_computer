...
void US_100::USART3_Init(u32 bound)
{
  //GPIO端口设置
...
void US_100::USART3_IRQHandler(void)                	//串口3中断服务程序
{
		u8 Res;
...
void US_100::USART3_SendData(u8 data )        													//串口3发送
{
...
u8 	US_100::USART3_ReadData(void )                												//串口3接收
{
        u8 data;
...
u16 US_100::US100_GetVal(void )  																// 返回单位 毫米 mm 
{
